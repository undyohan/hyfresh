    ...
    <div class="d-flex justify-content-end align-items-center mb-2">
      <ul class="nav justify-content-end">
        <c:if test="${sesInfo eq null }"> 
          <li class="nav-item">
            <a class="nav-link text-muted" href="/member/join">회원가입</a>
          </li>
          <li class="nav-item">
            <a class="nav-link text-muted" href="/member/login">로그인</a>
          </li>
        </c:if>
        <c:if test="${sesInfo ne null }">
          ...
          <li>
            <a class="nav-link text-muted" href="/member/mypage">마이페이지</a>
          </li>
        <li class="nav-item">
          <a class="nav-link text-muted" href="/member/logout">로그아웃</a>
        </li>
        </c:if>
      </ul>
