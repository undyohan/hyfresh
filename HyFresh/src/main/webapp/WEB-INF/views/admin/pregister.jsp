...
<form class="form-signin" action="/admin/pregister" method="post">
    ...
    <div class="d-block my-3">
      <label for="dfee">배송비</label>
	    <div class="custom-control custom-radio">
	      <input id="freedelivery" name="dfee" type="radio" class="custom-control-input" checked required>
	    ...
	    <div class="custom-control custom-radio">
	      ...
	      <label class="custom-control-label" for="chargedelivery">유료배송</label>
	    </div>
    </div>
  </div>
  <hr class="my-4">
